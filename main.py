...
def main():
    ...
    dict_2016 = ext.Extract('./2016.csv').build_dict()
...
#    print('Done')
    ...
    bar.Bar(trafic_rer_2016, trafic_rer_2015, trafic_rer_2014, trafic_rer_2013, stations_rer, 'Stations', 'Trafic', 'Trafic Stations RER')
