...
def main():
    ...
    bar.Bar(trafic_rer_2016, trafic_rer_2015, trafic_rer_2014, trafic_rer_2013, stations_rer, 'Stations', 'Trafic', 'Trafic des 5 stations RER les plus fréquentées de la RATP')
    bar.Bar(trafic_metro_2016, trafic_metro_2015, trafic_metro_2014, trafic_metro_2013, stations_metro, 'Stations', 'Trafic', 'Trafic des 5 stations Métro les plus fréquentées de la RATP')
    bar.Bar(trafic_top5_2016, trafic_top5_2015, trafic_top5_2014, trafic_top5_2013, stations_top5, 'Stations', 'Trafic', 'Trafic des 5 stations les plus fréquentées de la RATP')
