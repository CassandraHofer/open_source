...
#MY_MAP = m = Basemap(llcrnrlon = 2.072485, llcrnrlat = 48.765248,
#            urcrnrlon = 2.620070, urcrnrlat = 48.972670,
#                 rsphere=(6378137.00, 6356752.3142), resolution='f',projection='merc')
#MY_MAP.bluemarble()
